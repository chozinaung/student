...
<body>
    ...
    <div id="sub_content">
    <form action="/student/courses" method="post" modelAttribute="course">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" id="id" path="id" name="id">
            </div>
        </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <input type="name" class="form-control" id="name" path="name" name="name">
            </div>
        </div>
