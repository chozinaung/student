...
<body>
    ...
    <div id="sub_content">
      <form action="/student/addstudent" method="post" modelAttribute="student">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" id="studentID" path="id" name="id">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" id="name"  path="name" name="name">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                ...
                <div class="col-md-4">
                    <input type="date" class="form-control" id="dob" path="dob" name="dob">
                </div>
            </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" id="phone" value="+95 " path="phone" name="phone">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
            ...
            <fieldset class="row mb-4">
                <div class="col-md-2"></div>
                <legend class="col-form-label col-md-2 pt-0">Course</legend>
