    ...
    <div id="sub_content">
        <form class="row g-3 mt-3 ms-2" >
            ...
            <div class="col-auto">
                ...
                <input type="text" class="form-control" id="staticEmail2" placeholder="User ID" path="id">
            </div>
            <div class="col-auto">
                <label for="inputPassword2" class="visually-hidden">User Name</label>
                <input type="text" class="form-control" id="inputPassword2" placeholder="User Name" path="username">
            </div>
           ...
           <div class="col-auto">
            ...
            <div class="col-auto">
                <button type="button" class="btn btn-secondary " onclick="location.href = 'USR001.html';">
                    Add
                </button>
